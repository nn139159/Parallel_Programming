...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    // Place non-divisible compensation at last block
    totalRows += (args->threadId == args->numThreads - 1) ?
    ...
    */
    ...
    // Interleaved Partitioning, assign every N-th row to a different thread
